...
public class RemindView extends TextView {
	 ...
	 */
	public RemindView(Context context, View target) {
	 ...
	 */
	public RemindView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}

	public RemindView(Context context, AttributeSet attrs, int defStyle) {
