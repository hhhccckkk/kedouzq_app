...
public class HongBaoAdpter extends BaseAdapter {
    ...
    public View getView(int arg0, View contentView, ViewGroup arg2) {
        ...
        contentView = LayoutInflater.from(context).inflate(R.layout.hongbao_item, null);
        viewHolder = new ViewHolder();
        viewHolder.contenTextView = (TextView) contentView.findViewById(R.id.hongbao_content);
        viewHolder.timeTextView = (TextView) contentView.findViewById(R.id.hongbao_time);
        viewHolder.button = (Button) contentView.findViewById(R.id.dakai);
        viewHolder.button.setTag(arg0);
        viewHolder.jinbTextView = (TextView) contentView.findViewById(R.id.HongBao_jinbi);
        ...
        if (isOpen == IS_OPEN) {
            ...
            viewHolder.jinbTextView.setVisibility(View.VISIBLE);
            viewHolder.jinbTextView.setText("+" + hongbaos.get(arg0).getPoint());
            viewHolder.button.setTextColor(context.getResources().getColor(R.color.text_9999));
            viewHolder.button.setEnabled(false);
        } else {
            viewHolder.jinbTextView.setVisibility(View.GONE);
