...
public class Request {
	...
	public static void addPoint(int kid, int num, String type, int point,boolean isTg,
			HCKHttpResponseHandler handler) {
		try {
			RequestParams params = new RequestParams();
			params.put("uid", MyData.getData().getUserBean().getId() + "");
	 ...
	 * @param handler
	 */
	public static void getHongBao(RequestParams params,
			HCKHttpResponseHandler handler) {
		params.put("uid", MyData.getData().getUserBean().getId() + "");
	 ...
	 * @param handler
	 */
	public static void updateHongBao(RequestParams params,
			HCKHttpResponseHandler handler) {
	 ...
	 * @param handler
	 */
	public static void updateUserInfo(RequestParams params,
			HCKHttpResponseHandler handler) {
	 ...
	 * @param handler
	 */
	public static void getMsg(RequestParams params,
			HCKHttpResponseHandler handler) {
	 ...
	 * @param handler
	 */
	public static void deleteMsg(RequestParams params,
			HCKHttpResponseHandler handler) {
	 ...
	 * @param handler
	 */
	public static void addYiJian(RequestParams params,
			HCKHttpResponseHandler handler) {
	 ...
	 * @param handler
	 */
	public static void addOrder(RequestParams params,
			HCKHttpResponseHandler handler) {
	 ...
	 * 打包apk
	 */
	public static void daBao(HCKHttpResponseHandler handler,
			RequestParams params) {
